        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="deleteCart btn btn-secondary"><?php echo $lang['Supprimer']?></a><a type="button" class="btn btn-warning" data-dismiss="modal"><?php echo $lang['Continuer']?></a><a href="checkout.php" class="btn btn-primary payement-btn">Payer</a></div>
            </div>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            $(".payement-btn").click(function (e) { 
                ...
                if(shopcart == ""){
                    ...
                    window.location.assign("../pages/checkout.php")
                }
                outputCart();
            })
            function outputCart() {
                if (localStorage["sca"] != null) {
                    shopcart = JSON.parse(localStorage["sca"].toString());
                    //console.log(localStorage["sca"]);
                    $('#checkoutdiv').show();
                }
                var holderHTML = '';
                var total = 0;
