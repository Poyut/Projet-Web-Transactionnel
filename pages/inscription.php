...
<head>
	...
	<title>Moderma|Inscription</title>
</head>

<body>
	<section id="main">
		<p id="sign"><?php echo $lang['inscrire']?></p>
		<div id="container">
			<form class="centrer" action="../../ressources/scripts/compte/compte-creation.php" method="post" enctype="multipart/form-data">
				<div class="champ">
				...
				<div id="champ-submit">
					<input type="submit" value="<?php echo $lang['CONFIRMER']?>">
				</div>
			</form>
		</div>
	</section>
